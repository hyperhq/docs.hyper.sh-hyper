...
### Commit a container
    ...
    $ hyper commit c3f279d17e0a  SvenDowideit/testimage:version3
    f5283438590d
    $ hyper images
...
### Commit a container with new `CMD` and `EXPOSE` instructions 
    ...
    $ hyper commit --change='CMD ["apachectl", "-DFOREGROUND"]' -c "EXPOSE 80" c3f279d17e0a  SvenDowideit/testimage:version4
    f5283438590d
    
    $ hyper run -d SvenDowideit/testimage:version4
